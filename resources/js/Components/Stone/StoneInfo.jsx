...
export default function StoneInfo({ stone, hasAdminAccess, isOwner }) {
    return (
        <div className="mt-4">
            ...
            {isOwner && <CustomText h3 bold title={`Code: ${stone.code}`} textColor="text-sm text-gray-700" />}

            <CustomText h4 italic title={`Location: ${stone.city}, ${stone.country}`} textColor="text-sm text-gray-900" margin="my-3" />
